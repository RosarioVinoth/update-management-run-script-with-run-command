...
$vmIds | ForEach-Object {
    ...
    $newJob = Start-ThreadJob -ScriptBlock { param($resourceGroup, $vmName, $scriptPath) Invoke-AzVMRunCommand -ResourceGroupName $resourceGroup -VMName $VmName -CommandId 'RunShellScript' -ScriptPath $scriptPath} -ArgumentList $rg, $name, $fullPath
